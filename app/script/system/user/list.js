define(['app'], function(app) {
    ...
    return app.controller('system.user.list', ['$scope', 'SSystemUser', 'sl', '$timeout','print', function($scope, service, sl,  $timeout,printer) {
        ...
        var page = {
            ...
            fields : {
                options : [
                    ...
                    { "key": "user_login", "value": "登录名", "display": true , "sort":1}, 
                    { "key": "user_nicename", "value": "昵称", "sort": 1, "display": true },
                    { "key": "name", "value": "所属酒店", "display": true }, 
                    { "key": "mobile", "value": "联系电话", "display": true }, 
                    { "key": "user_email", "value": "邮箱", "display": true }, 
                    { 
                        "key": "user_status", "value": "状态", "display": true,
                        "link":"status","group":[
                            {"id":"-1" , "label":"全部"},
                            {"id":"1" , "label":"启用"},
                            {"id":"0" , "label":"禁用"}
