define(['app', 'moment'], function(app, moment) {
    ...
    return app.controller('BaseZoneEditCtrl', ['$scope', 'BaseZoneService', 'sl', '$timeout','$stateParams', function($scope, service, sl,  $timeout,$stateParams) {
        ...
        var page = {
            ...
            title: (isEdit ? '编辑' : isView ? '查看' : '新增') + '库区',

            fields : {"status":"","remark":"","ownerId":"","warehouseId":"","type":"","code":"","name":""},
