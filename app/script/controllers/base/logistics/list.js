define(['app', 'moment'], function(app, moment) {
    ...
    return app.controller('BaseLogisticsListCtrl', ['$scope', 'BaseLogisticsService', 'sl', '$timeout', function($scope, service, sl,  $timeout) {
        ...
        var page = {
            ...
            fields : {
                options : [
                    ...
                    { "key": "logisticsName", "value": "承运商名称", "display": true }, 
                    { "key": "logisticsCode", "value": "承运商编码", "sort": 1, "display": true },
                    { "key": "cContact", "value": "联系人", "display": true }, 
                    { "key": "cTel", "value": "联系电话", "display": true }, 
                    { "key": "cMobile", "value": "手机", "display": false }, 
                    { "key": "cFax", "value": "传真", "display": false }, 
                    { "key": "cEmail", "value": "邮箱", "display": true }, 
                    { 
            ...
            params:{
                ...
                options : {
                    ...
                    //用于快速搜索
                    quick : [
                        {title:'承运商名称',model:'logisticsName'},
                        {title:'承运商编码',model:'logisticsCode'}
                    ]
                }
                ,
                // 分页数据
