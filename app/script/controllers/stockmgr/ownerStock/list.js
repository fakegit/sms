...
define(['app', 'moment'], function(app, moment) {
    ...
    return app.controller('StockmgrOwnerStockListCtrl', ['$scope', 'StockmgrOwnerStockService', 'sl', '$timeout', function($scope, service, sl,  $timeout) {
        ...
        var page = {
            ...
            fields : {
                options : [
                    ...
                    { "key": "ownerCode", "value": "商家编码", "display": true },
                    { "key": "quantity", "value": "库存总量", "display": true },
                    { "key": "locationNum", "value": "占用库位数量", "display": true },
                    { "key": "volume", "value": "体积（立方米）", "display": true },
                    { "key": "weight", "value":"重量（千克）", "display": true },
                    { "key": "locationVolume", "value": "占用库容（立方米）", "display": true },
