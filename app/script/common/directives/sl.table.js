define(['app'], function(app) {
    ...
    app.directive('sltSort', ['$timeout', function($timeout) {
        return {
            restrict: 'A',
            ...
            link: function(scope, element, attr, ctrl) {
                ...
                var field = attr.sltSort;
                console.log(field)
                if(!field) return;

                var classAscent = 'sorting_asc';
                var classDescent = 'sorting_desc';
                var classDefault = 'sorting';

                var stateClasses = [classDefault, classAscent, classDescent];

                scope.$watch(function() {
                    return ctrl.getSort(field)
