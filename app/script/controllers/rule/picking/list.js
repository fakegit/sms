define(['app'], function(app) {
    ...
    return app.controller('RulePickingListCtrl', ['$scope', 'RulePickingService', 'sl', '$timeout', function($scope, service, sl,  $timeout) {
        ...
        function toggle(row){
            ...
            service.toggle({ruleId:id , status:toggle_state}).then(function(resp){
                if(resp.returnCode){
