define(['app', 'moment'], function(app, moment) {
    ...
    return app.controller('RuleWaveEditCtrl', ['$scope', 'RuleWaveService', 'sl', '$timeout','$stateParams','ModalService', function($scope, service, sl,  $timeout,$stateParams,modalService) {
        ...
        var page = {
            ...
            title: (isEdit ? '编辑' : isView ? '查看' : '新增') + '波次规则',
...
/*
        ...
        function detail_edit(row, mode){
            ...
            modalService.open('rule/wave/detail/edit.html',{
                page : {
                    view : mode == 2, 
                    edit : !mode,
