...
define(['app', 'moment'], function(app, moment) {
    ...
    return app.controller('CheckRecordsListCtrl', ['$scope', 'CheckRecordsListService', 'sl', '$timeout','ModalService', function($scope, service, sl,  $timeout,ModalService) {
        ...
        var page = {
            ...
            fields : {
                options : [
                    ...
                    { "key": "countQuantity", "value": "盘点数量", "display": true },
                    { "key": "operator", "value": "操作人", "display": true },
                    { "key": "countTime", "value": "操作时间", "display": true }
                ],
                ...
                options : {
                    ...
                    base : [{
                        ...
                        group: [
                            ...
                            //{title:'商家批号',model:['beginExpiryDate','endExpiryDate'],type:'datetime'}
