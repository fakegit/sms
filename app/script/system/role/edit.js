define(['app'], function(app, moment) {
    ...
    return app.controller('system.role.edit', ['$scope', 'SSystemRole', 'sl', '$timeout','$stateParams', function($scope, service, sl,  $timeout,$stateParams) {
        ...
        var page = {
            ...
            title: (isEdit ? '编辑' : isView ? '查看' : '新增') + '角色',
