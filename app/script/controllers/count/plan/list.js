...
define(['app'], function(app) {
    ...
    return app.controller('CountPlanListCtrl', ['$scope', 'CountPlanService', 'sl', '$timeout', function($scope, service, sl,  $timeout) {
        ...
        var page = {
            ...
            fields : {
                options : [
                    ...
                    { "key": "code", "value": "盘点计划号", "display": true }, 
                    { "key": "warehouseName", "value": "仓库名称", "sort": 1, "display": true },
                    { "key": "typeName", "value": "类型", "display": true }, 
                    { "key": "statusName", "value": "状态", "display": true ,}, 
                    { "key": "planDetailNum", "value": "明细总数", "display": true },
                    
                    { "key": "countedDetailNum", "value": "已盘明细数", "display": true },
                    { "key": "createdBy", "value": "创建人", "display": true },
                    { "key": "planLocNum", "value": "盘点库位数", "display": true },
                    { "key": "countedLocNum", "value": "已盘库位数", "display": true },
                    { "key": "createdTime", "value": "创建时间", "display": true },
                    { "key": "beginTime", "value": "开始时间", "display": true },
                    { "key": "endTime", "value": "结束时间", "display": true },
                    { "key": "remark", "value": "备注", "display": true }
                ],
            ...
            deps:{
                ...
                status:"COUNT_ADJUST_BILL_STATUS"
            },
            ...
            params:{
                ...
                options : {
                    ...
                    base : [{
                        title: "基础",
                        group: [
                            {title:'盘点计划号',model:'product_id',type:'input',value:'0001'},
                            {title:'仓库名称',model:'name',type:'input'},
                            {title:'状态',model:'barCode',type:'input'},
                    ...
                    //用于快速搜索
                    quick : [
                        {title:'盘点计划号',model:'name'},
                        {title:'仓库名称',model:'code'},
                        {title:'状态',model:'warehouseName'},
                    ]
                }
                ,
                // 分页数据
        ...
        function afterList(data) {
            ...
            sl.format.timestamp(data,['createdTime','beginTime','endTime']);
