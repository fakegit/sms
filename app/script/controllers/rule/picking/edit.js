define(['app', 'moment'], function(app, moment) {
    ...
    return app.controller('RulePickingEditCtrl', ['$scope', 'RulePickingService', 'sl', '$timeout','$stateParams','ModalService', function($scope, service, sl,  $timeout,$stateParams,modalService) {
        ...
        var page = {
            ...
            title: (isEdit ? '编辑' : isView ? '查看' : '新增') + '拣货规则',

            fields : {"status":"","remark":"","warehouseId":"","ownerId":"","ruleCode":"","ruleName":"","pickingRuleDetailVOList":"","id":""},
...
/*
        ...
        function detail_edit(row, mode){
            ...
            modalService.open('rule/picking/detail/edit.html',{
                page : {
                    view : mode == 2, 
                    edit : !mode,
